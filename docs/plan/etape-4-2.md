...
7. **Le banc exige la cadence là où elle se mesure, et seulement là.** L'intégration continue n'a pas de carte graphique: SwiftShader y rasterise tout au processeur, à 2,7 à 4,9 images par seconde selon la charge. Le banc détecte le moteur qui dessine. Sur carte graphique, il exige au moins 30 images par seconde à chaque charge et une cadence à 500 sprites supérieure à la moitié de celle à 100. En rendu logiciel, il n'exige que le coût par image de notre propre code, toutes les entités dessinées et des images qui avancent. Un plancher commun a d'abord fait échouer la CI sans régression. Les valeurs mesurées dans les deux situations sont consignées dans le handoff.
