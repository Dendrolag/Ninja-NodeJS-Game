...
3. **Le joueur tire en route, chaque fois qu'un faux ninja est dans son cône**, au lieu de s'arrêter à portée, lever le pouce, puis tirer une fois. Un tir sans effet ne coûte rien, et c'est ainsi qu'on joue. La mission s'achève quand le serveur compte un faux ninja à Alice.
...
- `tests/e2e/harnais/pilote.ts`: l'action faite en route, et la durée de la ruée.
