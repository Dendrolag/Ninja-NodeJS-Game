 ...
 */
const PLAN = [
  { cellule: [0, 0], nature: 'cour', ouvertures: [{ cote: 'est', part: 0 }, { cote: 'est', part: 1 }] },
  { cellule: [0, 1], nature: 'cour', ouvertures: [{ cote: 'sud', part: 0 }, { cote: 'sud', part: 1 }] },
  { cellule: [0, 2], nature: 'cour', fusion: 'est', ouvertures: [{ cote: 'sud', part: 0 }, { cote: 'sud', part: 1 }] },
  { cellule: [1, 0], nature: 'cour', fusion: 'sud', ouvertures: [{ cote: 'est', part: 0 }, { cote: 'est', part: 1 }] },
  { cellule: [1, 1], nature: 'plein' },
  { cellule: [1, 2], nature: 'cour', fusion: 'est', ouvertures: [{ cote: 'ouest', part: 0 }, { cote: 'ouest', part: 1 }] },
  { cellule: [2, 1], nature: 'cour', ouvertures: [{ cote: 'nord', part: 0 }, { cote: 'nord', part: 1 }] },
  { cellule: [2, 2], nature: 'cour', fusion: 'est', ouvertures: [{ cote: 'nord', part: 0 }, { cote: 'nord', part: 1 }] },
];
