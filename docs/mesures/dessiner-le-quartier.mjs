 ...
 */
const PLAN = [
  { cellule: [0, 0], nature: 'cour', ouvertures: [{ cote: 'est', part: 0.65 }] },
  { cellule: [0, 1], nature: 'cour', ouvertures: [{ cote: 'sud', part: 0.35 }] },
  { cellule: [0, 2], nature: 'cour', fusion: 'est', ouvertures: [{ cote: 'sud', part: 0.3 }] },
  { cellule: [1, 0], nature: 'cour', fusion: 'sud', ouvertures: [{ cote: 'est', part: 0.4 }] },
  { cellule: [1, 1], nature: 'plein' },
  { cellule: [1, 2], nature: 'cour', fusion: 'est', ouvertures: [{ cote: 'ouest', part: 0.5 }] },
  { cellule: [2, 1], nature: 'cour', ouvertures: [{ cote: 'nord', part: 0.55 }] },
  { cellule: [2, 2], nature: 'cour', fusion: 'est', ouvertures: [{ cote: 'nord', part: 0.4 }] },
];
