...
| Tension 2, six modes                 | Un seul mode jouable en v1. Les propositions Chasse, Battle Royale, Équipes et Chaos n'étaient pas validées: tuile unique « à venir ». Le Tactique est arrivé à l'étape 7.1, et les Équipes à l'étape 7.2, avec les règles que le porteur du projet a tranchées; Chasse, Battle Royale et Chaos restent des propositions. |
...
| ------------ | ------------------------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `mode`       | `'classique'`, `'tactique'` ou `'equipes'` | `classique` | Le Tactique depuis l'étape 7.1, les Équipes depuis la 7.2. **Figé à la création**: changer de mode pourrait changer la capacité, et exclure des joueurs déjà présents. |
...
| capacité     | entier, déduit du mode     | 12          | **Pas un champ**: une propriété du mode. Classique et Tactique: 12 au plus, 1 pour lancer. Équipes: 12 au plus, six par équipe, et un joueur dans chaque équipe pour lancer. |
