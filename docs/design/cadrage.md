...
| ------------ | ------------------------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `mode`       | `'classique'`, `'tactique'`, `'equipes'` ou `'chasse'` | `classique` | Le Tactique depuis l'étape 7.1, les Équipes depuis la 7.2, la Chasse depuis la 7.3. **Figé à la création**: changer de mode pourrait changer la capacité, et exclure des joueurs déjà présents. |
...
| capacité     | entier, déduit du mode     | 12          | **Pas un champ**: une propriété du mode. Classique et Tactique: 12 au plus, 1 pour lancer. Équipes: 12 au plus, six par équipe, et un joueur dans chaque équipe pour lancer. Chasse: 10 au plus, 2 pour lancer, et pas d'entrée une fois lancée. |
