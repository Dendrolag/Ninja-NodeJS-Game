 ...
 *
 * Il ne teste pas le jeu, qui n'existe pas encore. Il prouve seulement que
 * Playwright est installe, que les navigateurs se lancent, et que la chaine de
 * bout en bout tourne en local comme en integration continue.
 *
 * Il ne demarre aucun serveur: la page est fournie directement au navigateur.
 * Les vrais parcours multi-clients arrivent a l'etape 4.4.
 */
