...
2. Capturer un joueur transfère **tous** ses bots d'un coup. Précision du 16 septembre 2026 (étape 7.3): en mode Chasse, capturer une proie ne transfère rien, elle devient traqueur. En mode Massacre (étape 7.4), on ne capture plus: un coup de katana tue.
